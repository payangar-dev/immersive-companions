...
/**
 * Waystones compatibility handler for Fabric.
 ...
 */
public class WaystonesCompatFabric implements TeleportCompatManager.TeleportModHandler {

    public static final WaystonesCompatFabric INSTANCE = new WaystonesCompatFabric();

    private WaystonesCompatFabric() {
    ...
    public static void init() {
        ...
        Balm.getEvents().onEvent(WaystoneTeleportEvent.Pre.class, WaystonesCompatFabric::onWaystoneTeleportPre);
